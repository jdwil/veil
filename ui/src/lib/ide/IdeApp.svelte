<script lang="ts">
  ...
  import VeilNode from '$lib/ide/VeilNode.svelte';
  import Palette from '$lib/ide/Palette.svelte';
  import CreateConstructMenu, { type CreateItem } from '$lib/ide/CreateConstructMenu.svelte';
  import PropertyEditor from '$lib/ide/PropertyEditor.svelte';
  import DiagnosticsPanel from '$lib/ide/DiagnosticsPanel.svelte';
  import CodePreview from '$lib/ide/CodePreview.svelte';
  import ReviewDock from '$lib/ide/ReviewDock.svelte';
  ...
  import { setNativeProjectSlug } from '$lib/ide/store';
