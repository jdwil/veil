...
| **Projects (runtime local)** | Configured **projects directory**; each product = **independent git repo**; multi-open = **runtime launches IDE per project** ([PROJECT_LAYOUT.md](../docs/PROJECT_LAYOUT.md)) |
