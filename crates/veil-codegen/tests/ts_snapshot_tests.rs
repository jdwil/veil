...
// NOTE: gen_svelte_component was removed — Svelte generation is now part of
// the unified generate_ts_ir pipeline. Component snapshot tests live in the
// full-project snapshots (ts_snapshot_hello_world etc.).
