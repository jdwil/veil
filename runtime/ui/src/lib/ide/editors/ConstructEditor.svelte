<script lang="ts">
  ...
  import FieldsEditor from '$lib/ide/FieldsEditor.svelte';
  import MethodEditor from '$lib/ide/MethodEditor.svelte';
  import { BlockEditor } from '$lib/ide/editors';
...
<style>
  ...
  .ce-section-label { font-size: 10px; color: var(--veil-text-dim); text-transform: uppercase; font-weight: 600; }
</style>
